...
class SampleDataUtils {
    ...
    companion object {
        private val sampleStoreInfo = mutableListOf(
            ...
            StoreInfoData("9","비와별닭갈비 롯데몰은평점", "https://search.pstatic.net/common/?src=https%3A%2F%2Fldb-phinf.pstatic.net%2F20230519_127%2F1684482027520Pp9Co_JPEG%2F%25C0%25FC%25C3%25BC_01.jpg", null, StoreCategory.RESTAURANT, "진관동", 1138069000, 1),
