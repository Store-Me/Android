...
class SignupOnboardingViewModel: ViewModel() {
    fun getOnboardingImageList(accountType: AccountType): List<Int> {
    ...
    fun getOnboardingTitleList(accountType: AccountType): List<String> {
        return when(accountType){
            AccountType.CUSTOMER -> {
    ...
    fun getOnboardingContentList(accountType: AccountType): List<String> {
        return when(accountType){
            AccountType.CUSTOMER -> {
                listOf(
